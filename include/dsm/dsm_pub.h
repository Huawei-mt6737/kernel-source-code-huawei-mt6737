...
#define DSM_GSENSOR_I2C_BUS_ERROR_NO			(21100)
#define DSM_GSENSOR_I2C_DATA_ERROR_NO			(21101)
#define DSM_LPSENSOR_I2C_ERROR_NO				(21102)
#define DSM_MSENSOR_I2C_BUS_ERROR_NO			(21116)
#define DSM_MSENSOR_I2C_DATA_ERROR_NO			(21117)
