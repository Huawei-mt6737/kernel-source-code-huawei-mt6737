...
#include "ov5670_827_mipi_Sensor.h"

#define PFX "ov5670_827_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = OV5670MIPI_827_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		spin_unlock(&imgsensor_drv_lock);
		do {
			if(0x5600==(read_cmos_sensor(0x300B) << 8))
				{
...
UINT32 OV5670_827_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
