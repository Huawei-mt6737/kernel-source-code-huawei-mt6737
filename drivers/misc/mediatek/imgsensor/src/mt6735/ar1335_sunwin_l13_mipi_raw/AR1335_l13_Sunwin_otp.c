...
#define CAM_CAL_DRVNAME "AR1335_L13_MIPIRAW_OTP_CAL"
...
static void eeprom_gt24c64a_write8(kal_uint16 addr, kal_uint8 para)
{
 ...
 static int read_ar1335_L13_LSC_info(void)
{
    int addr;
    int i = 0;
    u32 sum = 0;
...
static int read_ar1335_L13_AWB_info(void)
{
    int addr;
...
static int read_ar1335_L13_AF_info(void)
{
    int i = 0;
    u16 AF_otp_data[8];
...
static int read_otp(struct otp_struct *otp_ptr)
{
    ...
    read_ar1335_L13_AWB_info();
    read_ar1335_L13_AF_info();
    read_ar1335_L13_LSC_info();
for(i=0;i<23;i++)
{
...
static long ar1335_L13_otp_Ioctl_Compat(struct file *filp, unsigned int cmd, unsigned long arg)
{
    long ret;
    COMPAT_stCAM_CAL_INFO_STRUCT __user *data32;
    stCAM_CAL_INFO_STRUCT __user *data;
...
static const struct file_operations g_stCAM_CAL_fops =
{
    ...
    //.ioctl = CAM_CAL_Ioctl
#ifdef CONFIG_COMPAT
    .compat_ioctl = ar1335_L13_otp_Ioctl_Compat,
#endif
