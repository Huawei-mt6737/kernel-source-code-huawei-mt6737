...
#include "s5k3l2_mipiraw_chicony_l13_Sensor.h"
#include "s5k3l2_chicony_l13_otp.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "S5K3L2_chicony_l13_camera_sensor"
#define LOG_1 LOG_INF("S5K3L2,CHICONY,MIPI 4LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = S5K3L2_CHICONY_L13_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
{	
	...
	write_cmos_sensor1(0x0136, 0x1A00);
	write_cmos_sensor1(0x0304, 0x0006);
	write_cmos_sensor1(0x0306, 0x00C7);
	write_cmos_sensor1(0x030C, 0x0006);
	write_cmos_sensor1(0x030E, 0x00F7);
...
{	
	...
	write_cmos_sensor1(0x0306, 0x00C7);
	write_cmos_sensor1(0x030C, 0x0006);
	write_cmos_sensor1(0x030E, 0x00F7);//pclk
	write_cmos_sensor1(0x0302, 0x0001);
	write_cmos_sensor1(0x0300, 0x0002);
	write_cmos_sensor1(0x030A, 0x0001);
	write_cmos_sensor1(0x0308, 0x0008);
...
{	
	...
	write_cmos_sensor1(0x6F12, 0x00C7);
	write_cmos_sensor1(0x602A, 0x030C);
	write_cmos_sensor1(0x6F12, 0x0006);
	write_cmos_sensor1(0x6F12, 0x00B0);
...
static int s5k3l2_chicony_get_module_id(void)
{
    return eeprom_gt24c64a_read8(0x0003);
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        spin_unlock(&imgsensor_drv_lock);
        do {
		if(0x3000==(read_cmos_sensor(0x0000)<<8))
		{
	            *sensor_id = return_sensor_id();
		    (*sensor_id)+=2;
	            //module_id = s5k3l2_chicony_get_module_id();
	            if (*sensor_id == imgsensor_info.sensor_id) {
	                LOG_INF("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
	                sensor_init();
	                s5k3l2_chicony_l13_otp_cali();
	                return ERROR_NONE;
	            } else {
	                *sensor_id = 0xFFFFFFFF;
	            }
...
UINT32 S5K3L2_CHICONY_L13_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
