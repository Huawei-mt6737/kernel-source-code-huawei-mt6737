...
static imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0x85ab8f21,//0xa7f3e34,0x722b3840,        //checksum value for Camera Auto Test
    .pre = {
...
static void preview_setting(void)
{
 ...
 /// stop_streaming
	...
	write_cmos_sensor_2byte(0x0306, 0x6666); 	// PLL_MULTIPLIER
	write_cmos_sensor_2byte(0x0308, 0x000A); 	// OP_PIX_CLK_DIV
	write_cmos_sensor_2byte(0x030A, 0x0001); 	// OP_SYS_CLK_DIV
	write_cmos_sensor_2byte(0x0112, 0x0A0A); 	// CCP_DATA_FORMAT
	write_cmos_sensor_2byte(0x3016, 0x0101); 	// ROW_SPEED
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  /// stop_streaming
	...
	write_cmos_sensor_2byte(0x0302, 0x0001); 	// VT_SYS_CLK_DIV
	write_cmos_sensor_2byte(0x0304, 0x0202); 	// PRE_PLL_CLK_DIV
	write_cmos_sensor_2byte(0x0306, 0x5555); 	// PLL_MULTIPLIER
	write_cmos_sensor_2byte(0x0308, 0x000A); 	// OP_PIX_CLK_DIV
	write_cmos_sensor_2byte(0x030A, 0x0001); 	// OP_SYS_CLK_DIV
	write_cmos_sensor_2byte(0x0112, 0x0A0A); 	// CCP_DATA_FORMAT
	write_cmos_sensor_2byte(0x3016, 0x0101); 	// ROW_SPEED
...
UINT32 AR1335_SUNWIN_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
