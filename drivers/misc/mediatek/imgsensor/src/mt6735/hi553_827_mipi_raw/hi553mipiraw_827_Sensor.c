...
#include "hi553mipiraw_827_Sensor.h"
...
#define LOG_1 LOG_INF("hi553_827,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI553_827_SENSOR_ID,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
	
	.checksum_value = 0xe48556a,		//checksum value for Camera Auto Test

	.pre = {
		.pclk = 165100000,				//record different mode's pclk
...
////////////////////////////////////////////////
	...
	write_cmos_sensor(0x0b16, 0x7f07);
	...
	write_cmos_sensor(0x0b24, 0xa690); 
...
LOG_INF("HI553 RG_ratio_unit = 0x%x, BG_ratio_unit = 0x%x, RG_ratio_golden = 0x%x, BG_ratio_golden = 0x%x, wbcheck \n",\
...
static void hi553_otp_cali_read(void)
{
    ...
    static struct hi553_otp_struct hi553_otp;
    LOG_INF("HI553 huaquan_otp_cali \n");
    LOG_INF("Read sensor id fail, id: 0x%x, hi553_otp_read_flag : 0x%d\n", hi553_otp_read_flag);
    otp_init_setting();
    hi553_otp_read();
...
UINT32 HI553_827_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
