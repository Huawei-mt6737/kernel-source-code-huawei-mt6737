...
LOG_INF("HI556 addr = 0x%x \n", addr);
	...
	checksum = (hi556_otp.module_integrator_id + hi556_otp.AF_Flag + hi556_otp.prodyction_year + hi556_otp.production_month + hi556_otp.production_day + hi556_otp.sensor_id + hi556_otp.lens_id) % 0xFF + 1;
...
LOG_INF("HI556 module_integrator_id = 0x%x, AF_Flag = 0x%x, prodyction_year = 0x%x, production_month = 0x%x, production_day = 0x%x, sensor_id = 0x%x, lens_id = 0x%x, infocheck = 0x%x \n",\
	...
	hi556_otp.WB_FLAG = OTP_read_cmos_sensor(0x435);
...
static int hi556_otp_apply(struct hi556_otp_struct *otp_ptr)
{
	...
	checksum = (hi556_otp.wb_data[0] + hi556_otp.wb_data[1] + hi556_otp.wb_data[2] + hi556_otp.wb_data[3] + hi556_otp.wb_data[4] + hi556_otp.wb_data[5] ) % 0xFF+ 1;
...
LOG_INF("HI556 RG_ratio_unit = 0x%x, BG_ratio_unit = 0x%x, RG_ratio_golden = 0x%x, BG_ratio_golden = 0x%x, wbcheck \n",\
...
static void hi556_otp_cali_read(void)
{
    ...
    LOG_INF("Read sensor id fail, id: 0x%x, hi556_otp_read_flag : 0x%d\n", hi556_otp_read_flag);
    otp_init_setting();
    hi556_otp_read();
