...
#include "s5k3l2mipiraw_ofilm_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "S5K3L2_ofilm_camera_sensor"
#define LOG_1 LOG_INF("S5K3L2,OFILM,MIPI 4LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = S5K3L2_OFILM_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static int s5k3l2_ofilm_get_module_id(void)
{
		...
		if(0x3000==(read_cmos_sensor(0x0000)<<8))
			{
		            *sensor_id = return_sensor_id();
		            (*sensor_id)++;
		          //  module_id = s5k3l2_ofilm_get_module_id();
...
UINT32 S5K3L2_OFILM_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
