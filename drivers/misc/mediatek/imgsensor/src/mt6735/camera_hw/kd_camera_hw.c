...
#define VOL_1000 1000000
	...
	if (On) {
		...
		printk("[PowerON]pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);
         ...
         if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW, currSensorName))){
           ...
           #if 1 //  change camera power on begin by likai
		   ...
		   if (GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMPDN])
                     mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[1][IDX_PS_CMPDN + IDX_PS_OFF]);
                     mdelay(1);
                if (GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMRST])
                     mtkcam_gpio_set(pinSetIdx, CAMRST, pinSet[1][IDX_PS_CMRST + IDX_PS_OFF]);
                     mdelay(1);
            #endif//  change camera power on end by likai
            ...
            mdelay(1);
         ...
         else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_827_MIPI_RAW, currSensorName))){
             // mt_set_gpio_mode(GPIO_SPI_MOSI_PIN,GPIO_MODE_00);
             //mt_set_gpio_dir(GPIO_SPI_MOSI_PIN,GPIO_DIR_OUT);
             //mt_set_gpio_out(GPIO_SPI_MOSI_PIN,GPIO_OUT_ONE);
             //First Power Pin low and Reset Pin Low
             ...
             if (GPIO_CAMERA_INVALID != pinSet[0][IDX_PS_CMPDN])
                 mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[0][IDX_PS_CMPDN + IDX_PS_OFF]);
             mdelay(1);

             if (GPIO_CAMERA_INVALID != pinSet[0][IDX_PS_CMRST])
                 mtkcam_gpio_set(pinSetIdx, CAMRST, pinSet[0][IDX_PS_CMRST + IDX_PS_OFF]);
             mdelay(1);
             if (GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMPDN])
                 mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[1][IDX_PS_CMPDN + IDX_PS_OFF]);
             mdelay(1);
	...
	else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV13850_MIPI_RAW, currSensorName)))
        {
            ...
            //mt_set_gpio_out(GPIO_SPI_MOSI_PIN,GPIO_OUT_ONE);
            //First Power Pin low and Reset Pin Low
			printk("travies add ov13850 power on");
	...
	else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV13850_L13_MIPI_RAW, currSensorName)))
	{
            //mt_set_gpio_mode(GPIO_SPI_MOSI_PIN,GPIO_MODE_00);
            //mt_set_gpio_dir(GPIO_SPI_MOSI_PIN,GPIO_DIR_OUT);
            //mt_set_gpio_out(GPIO_SPI_MOSI_PIN,GPIO_OUT_ONE);
            //First Power Pin low and Reset Pin Low
			printk("travies add ov13850_L13 power on");
		...
		if(pwd_high_flag)
         ...
         else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K3L2_CHICONY_MIPI_RAW, currSensorName)))
         {
             #if 1 //  change camera power on begin by likai
		   if (GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMPDN])
               	 mtkcam_gpio_set(1, CAMPDN, pinSet[1][IDX_PS_CMPDN + IDX_PS_OFF]);
...
else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K3L2_CHICONY_L13_MIPI_RAW, currSensorName)))		 
	  {
             #if 1 
		   if (GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMPDN])
               	 mtkcam_gpio_set(1, CAMPDN, pinSet[1][IDX_PS_CMPDN + IDX_PS_OFF]);
         ...
         else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K3L2_OFILM_MIPI_RAW, currSensorName)))
         {
         	  #if 1 //  change camera power on begin by likai
		   if (GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMPDN])
               	 mtkcam_gpio_set(1, CAMPDN, pinSet[1][IDX_PS_CMPDN + IDX_PS_OFF]);
...
//				mdelay(1);  
	            ...
	            //First Power Pin low and Reset Pin Low
                if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN]) {
                    mtkcam_gpio_set(pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]); /*This pin is NC*/
                }
 ...
 //AF_VCC
		   ...
		   if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST])
			...
			else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV8856QT_MIPI_RAW, currSensorName))) {
		#if 1 //  change camera power on begin by likai
		   if (GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMPDN])
               	 mtkcam_gpio_set(1, CAMPDN, pinSet[1][IDX_PS_CMPDN + IDX_PS_OFF]);
               	 mdelay(1);     
...
//               mdelay(1);     
		 if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST])
			...
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST]) {
                ...
                else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI553_827_MIPI_RAW, currSensorName))) {
                    /* First Power Pin low and Reset Pin Low */
#if 1 //  change camera power on begin by likai
                ...
                else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI556_MIPI_RAW, currSensorName))) {
                    /* First Power Pin low and Reset Pin Low */
#if 1 //  change camera power on begin by likai
 ...
 //enable active sensor
	   ...
	   if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST])
            ...
            mdelay(1);
                ...
                else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5005_827_MIPI_RAW, currSensorName))){
                    // mt_set_gpio_mode(GPIO_SPI_MOSI_PIN,GPIO_MODE_00);
                    //mt_set_gpio_dir(GPIO_SPI_MOSI_PIN,GPIO_DIR_OUT);
                    //mt_set_gpio_out(GPIO_SPI_MOSI_PIN,GPIO_OUT_ONE);
                    //First Power Pin low and Reset Pin Low
                ...
                else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_827_MIPI_RAW, currSensorName))){
                    // mt_set_gpio_mode(GPIO_SPI_MOSI_PIN,GPIO_MODE_00);
                    //mt_set_gpio_dir(GPIO_SPI_MOSI_PIN,GPIO_DIR_OUT);
                    //mt_set_gpio_out(GPIO_SPI_MOSI_PIN,GPIO_OUT_ONE);
                    //First Power Pin low and Reset Pin Low
...
else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_AR1335_SUNWIN_MIPI_RAW, currSensorName))) {
			/* First Power Pin low and Reset Pin Low */
			printk("AR1335 power on \n");
		#if 1 //  change camera power on begin by likai
		   if (GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMPDN])
               	 mtkcam_gpio_set(1, CAMPDN, pinSet[1][IDX_PS_CMPDN + IDX_PS_OFF]);
               	 mdelay(1);     
...
else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_AR1335_SUNWIN_L13_MIPI_RAW, currSensorName)))
	{
			/* First Power Pin low and Reset Pin Low */
			printk("AR1335_L13 power on \n");
		#if 1
		   if (GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMPDN])
               	 mtkcam_gpio_set(1, CAMPDN, pinSet[1][IDX_PS_CMPDN + IDX_PS_OFF]);
               	 mdelay(1);     
        ...
        if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW, currSensorName))){
           // mt_set_gpio_out(GPIO_SPI_MOSI_PIN,GPIO_OUT_ZERO);
            ...
            {
                 PK_DBG("[CAMERA SENSOR] Fail to OFF core power (VCAMD_SUB), power id = %d \n",VCAMD_SUB);
                 goto _kdCISModulePowerOn_exit_;
            }
            mdelay(1);
            ...
            if(TRUE != _hwPowerDown(VCAMA)) {
                PK_DBG("[CAMERA SENSOR] Fail to OFF analog power (VCAMA), power id= (%d) \n", VCAMA);
                //return -EIO;
                goto _kdCISModulePowerOn_exit_;
            }
	...
	else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV13850_MIPI_RAW, currSensorName)))
        {
            ...
            */
			...
			printk("travies add ov13850 power off");
	...
	else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV13850_L13_MIPI_RAW, currSensorName)))
	{
            ...
            */
			...
			printk("travies add ov13850_L13 power off");
