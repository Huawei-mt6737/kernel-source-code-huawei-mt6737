...
////////////////////////////////////////////////
	...
	write_cmos_sensor(0x0b14, 0x400c);
	write_cmos_sensor(0x0b16, 0x7f0f);
	...
	write_cmos_sensor(0x0b22, 0xfb80);
	write_cmos_sensor(0x0b24, 0x0500);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		//read_imx135_otp_mtk_fmt();
			...
			LOG_INF("Read sensor id fail, i2c write id: 0x%x, ReadOut sensor id: 0x%x, \n", imgsensor.i2c_write_id,*sensor_id);	
            retry--;
        } while(retry > 0);
        i++;
        retry = 1;
