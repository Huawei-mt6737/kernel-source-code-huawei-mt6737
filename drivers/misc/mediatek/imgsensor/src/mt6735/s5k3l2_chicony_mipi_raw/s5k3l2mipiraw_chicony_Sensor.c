...
#define PFX "S5K3L2_chicony_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = S5K3L2_CHICONY_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
UINT32 S5K3L2_CHICONY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
