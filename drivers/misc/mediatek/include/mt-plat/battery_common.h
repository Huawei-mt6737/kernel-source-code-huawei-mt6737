...
#define SYSTEM_OFF_VOLTAGE                  (3420)
...
#define MAX_USB_CV_CHARGING_TIME			(5*60*60)/* 5hr */
...
/*#define TEMP_POS_5_THRES_PLUS_X_DEGREE  10 */
...
#define HUAWEI_DYNAMIC_CHARGER  //huawei dpm

typedef enum{
g_charge_vol_1 = 1, //-4.6v
g_charge_vol_2,     //4.6~4.75v
g_charge_vol_3,		//4.75v-6v
}Charge_volsize_enum;
