...
#define ALSPS_SET_CALIBRATION_DATA			_IOW(ALSPS, 0x09, int)
#define ALSPS_GET_CALIBRATION_DATA			_IOR(ALSPS, 0x0A, int)
#define ALSPS_GET_PS_GAIN				_IOW(ALSPS, 0x1B, int)
#define ALSPS_SET_PS_GAIN				_IOR(ALSPS, 0x1C, int)
#define ALSPS_GET_ALS_GAIN				_IOW(ALSPS, 0x1D, int)
#define ALSPS_SET_ALS_GAIN				_IOR(ALSPS, 0x1E, int)
