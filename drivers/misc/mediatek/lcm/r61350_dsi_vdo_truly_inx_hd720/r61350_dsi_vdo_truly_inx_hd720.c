...
data_array[1] = 0x08b223c0;
data_array[2] = 0x007f0208;
dsi_set_cmdq(data_array, 3, 1);

data_array[0] = 0x00172902;
data_array[1] = 0x8a8a8ac1;
data_array[2] = 0x8a00008a;
data_array[3] = 0x0003008a;
...
data_array[0] = 0x00022902;
data_array[1] = 0x000075c3;
dsi_set_cmdq(data_array, 2, 1);

data_array[0] = 0x001d2902;
data_array[1] = 0x410407c5;
data_array[2] = 0x04444204;
data_array[3] = 0x000d0103;
data_array[4] = 0x00000000;
data_array[5] = 0x00020000;
data_array[6] = 0x00000000;
...
data_array[1] = 0x2a1a19c8;
data_array[2] = 0x26242220;
data_array[3] = 0x0f000928;
data_array[4] = 0x00001d00;
data_array[5] = 0x001d1d1d;
data_array[6] = 0x19000001;
data_array[7] = 0x23212b1a;
data_array[8] = 0x0a292725;
data_array[9] = 0x1d001000;
data_array[10] = 0x1d1d0000;
data_array[11] = 0x0002001d;
data_array[12] = 0x00008900;
data_array[13] = 0x00000100;
data_array[14] = 0x00000000;
data_array[15] = 0x00040301;
dsi_set_cmdq(data_array, 16, 1);

data_array[0] = 0x00272902;
data_array[1] = 0x2d2009ca;
data_array[2] = 0x69544a3e;
data_array[3] = 0x4392877a;
data_array[4] = 0x756d5b4e;
data_array[5] = 0xaea09281;
data_array[6] = 0x4033280f;
data_array[7] = 0x7c6b564c;
data_array[8] = 0x50459287;
data_array[9] = 0x8579715d;
data_array[10] = 0x00aea092;
dsi_set_cmdq(data_array, 11, 1);

data_array[0] = 0x00082902;
data_array[1] = 0x415502d0;
data_array[2] = 0x238f3600;
dsi_set_cmdq(data_array, 3, 1);
...
data_array[0] = 0x00032902;
data_array[1] = 0x00a400d4;
dsi_set_cmdq(data_array, 2, 1); // vcom
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_backporch					= 6; //7; // 10; // 16; // 20;   // zrl 2013-09-24  is important if up or down black/white line
...
static void lcm_init_power(void)
{
	...
	LCD_DEBUG("[r61350inx-truly]: %s, line%d,	ret=%d\n", __func__, __LINE__, ret);
	MDELAY(2);
...
static void lcm_init(void)
{
	...
	MDELAY(120);  //50
	init_lcm_registers();
	LCD_DEBUG("[r61350inx-truly]: %s, line%d\n", __func__, __LINE__);
}
...
static unsigned int lcm_compare_id(void)
{
	...
	LCD_DEBUG("[r61350inx-truly]: %s, line%d, id0=%x\n", __func__, __LINE__, id[0]);
	LCD_DEBUG("[r61350inx-truly: %s, line%d, id-da=%x\n", __func__, __LINE__, id1[0]);
	LCD_DEBUG("[r61350inx-truly]: %s, line%d, id1=%x\n", __func__, __LINE__, id[1]);
	LCD_DEBUG("[r61350inx-truly]: %s, line%d, id2=%x\n", __func__, __LINE__, id[2]);
	LCD_DEBUG("[r61350inx-truly]: %s, line%d, id3=%x\n", __func__, __LINE__, id[3]);
	LCD_DEBUG("[r61350inx-truly]: %s, line%d, id4=%x\n", __func__, __LINE__, id[4]);


	if(id[0] == 0x02 && id1[0] == 0x00) //&& id[2] == 0x13)
		return 1;
	LCD_DEBUG("[r61350inx-truly]: read id fail !\n");
	        return 0;
}

LCM_DRIVER r61350_dsi_vdo_truly_inx_hd720_lcm_drv = 
{
	.name		= "r61350_dsi_vdo_truly_inx_hd720",
