...
data_array[1] = 0x2b1d00ca;
data_array[2] = 0x6853473b;
data_array[3] = 0x48948879;
data_array[4] = 0x82786354;
data_array[5] = 0xBBAE9F8F;
data_array[6] = 0x3b2b1d00;
data_array[7] = 0x79685347;
data_array[8] = 0x54489488;
data_array[9] = 0x8F827863;
data_array[10] = 0x00BBAE9F;
dsi_set_cmdq(data_array, 11, 1);

data_array[0] = 0x00072902;
data_array[1] = 0x475002d0;
data_array[2] = 0x00902800;
dsi_set_cmdq(data_array, 3, 1);
...
static unsigned int lcm_compare_id(void)
{
	...
	if(id[0] == 0x02 && id1[0]== 0x1B)// && id[2] == 0x13)
		return 1;
	LCD_DEBUG("[r61350cpt-truly]: read id fail !\n");
	        return 0;
}

LCM_DRIVER r61350_dsi_vdo_truly_cpt_hd720_0x1B_lcm_drv = 
{
	.name		= "r61350_dsi_vdo_truly_cpt_hd720_0x1B",
