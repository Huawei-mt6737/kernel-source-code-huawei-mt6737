/*
 * DW9714AAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "DW9714AR1335L13AF_DRV"
...
static int s4AF_WriteReg(u16 a_u2Data)
{
	...
	{
	LOG_INF("s4AF_WriteReg a_u2Data %d\n",a_u2Data);
	}
	return 0;
}
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		char puSendCmd3[2] = {(char)(0XF2),(char)(0X38)};
...
/* ////////////////////////////////////////////////////////////// */
long DW9714AR1335L13AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int DW9714AR1335L13AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void DW9714AR1335L13AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
