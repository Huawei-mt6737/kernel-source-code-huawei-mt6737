...
//#define TPD_POWER_SOURCE_CUSTOM         	MT6328_POWER_LDO_VGP1 //modify by yifaguo
...
#define TPD_AUTO_UPGRADE					1//open by yifaguo 2016.7.8

#define USB_CHARGE_DETECT
#define FTS_SENSITIVITY_SWITCH
...
#endif
#define    FTS_HUAWEI_DESIGN

#define MTK_EN 									1
#define FTS_APK_DEBUG
#define SYSFS_DEBUG
//#define TPD_AUTO_UPGRADE
#define FTS_Vendor_1_ID		0x5a//Truly TP 
#define FTS_Vendor_2_ID		0xa6//Booyi TP
#define FT_TP									0
...
#if FTS_GESTRUE_EN	
		extern int ft_wakeup_gesture;
		extern int fts_Gesture_init(struct input_dev *input_dev);
		extern void fts_Gesture_exit(void);
