...
#ifdef CONFIG_CTP_GESTURE_WAKEUP
...
#define TPD_KEYS	 {KEY_MENU, KEY_HOME, KEY_BACK, KEY_SEND}
#endif
...
/* wengggaojian@wind-mobi.com 20160510 add begin */
...
#endif
/* wengggaojian@wind-mobi.com 20160510 add end */
/* ******************** For GT9XXF Start ***********************/
...
#define GTP_MUTI_FW_COMPATIBLE

#ifdef GTP_MUTI_FW_COMPATIBLE

#define GTP_SENSOR_ID_MAX 5
extern u8 global_sensor_id;
struct gtp_hw_info_type{
	char * vendor_name;
	int fw_length;
	unsigned char * gtp_firmware;
};

extern struct gtp_hw_info_type gtp_hw_info[];
#endif
...
extern int g_wakeup_gesture;//gloable gesture switch

extern void gesture_event_handler(struct input_dev * dev);
...
extern int tpd_gt9xx_dsm_report_err(int errno,int type);
#endif
