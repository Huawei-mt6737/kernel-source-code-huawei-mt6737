...
static void io_f2fs_sync_file_exit(void *ignore, struct inode *inode, bool need_cp, int datasync, int ret)
{
    struct io_trace_tag_attr tag_attr;
...
static void iotrace_register_tracepoints(void)
{
    ...
    */
    ...
    WARN_ON(ret);
    ret = register_trace_f2fs_sync_file_exit((void *)io_f2fs_sync_file_exit, NULL);
    WARN_ON(ret);
    ret = register_trace_f2fs_sync_fs(io_f2fs_sync_fs, NULL);
    WARN_ON(ret);
    ret = register_trace_f2fs_write_checkpoint((void *)io_f2fs_write_checkpoint, NULL);
    WARN_ON(ret);
